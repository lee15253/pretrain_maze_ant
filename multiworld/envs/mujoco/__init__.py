...
def register_my_envs():
    ...
    # BK (AntU-Med)
    register(
        id='AntUMedTrainEnv-v0',
        entry_point='multiworld.envs.mujoco.classic_mujoco.ant_maze:AntMazeEnv',
        kwargs={
            'model_path': 'classic_mujoco/ant_gear10_dt3_u_med.xml',
            'use_euler': True,
            'reward_type': 'vectorized_epos',
            'reset_and_goal_mode': 'uniform_pos_and_rot',
        }
    ...
    # BK: Maze small
    register(
        id='AntMazeSmallTrainEnv-v1',
        entry_point='multiworld.envs.mujoco.classic_mujoco.ant_maze:AntMazeEnv',
        kwargs={
            'model_path': 'classic_mujoco/ant_gear10_dt3_maze_small.xml',
            'use_euler': True,
            'reward_type': 'vectorized_epos',
            'reset_and_goal_mode': 'uniform_pos_and_rot',
        }
    ...
    # BK: Maze small
    register(
        id='NogoalAntMazeSmallTrainEnv-v1',
        entry_point='multiworld.envs.mujoco.classic_mujoco.ant_maze:AntMazeEnv',
        kwargs={
            'model_path': 'classic_mujoco/ant_gear10_dt3_maze_small.xml',
            'use_euler': True,
